...
- Still running into a normality issue, but it seems that using Simultaneous optimization transformation works best compared than no transformation, and other transformation
